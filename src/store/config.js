...
if (process.env.NODE_ENV == 'development') {
  var config = {
    ...
    BOOKS_PDF_MOBILE_SERVER_PREFIX: 'http://47.100.38.51:8080/mobile/index.html?docuri=http://127.0.0.1:9090/books/', // 图书pdf服务地址前缀
    MAGAZINES_PDF_SERVER_PREFIX: 'http://47.100.38.51:8080/pc/index.html?docuri=http://127.0.0.1:9090/magzines/', // 期刊pdf服务地址前缀
    MAGAZINES_PDF_MOBILE_SERVER_PREFIX: 'http://47.100.38.51:8080/mobile/index.html?docuri=http://127.0.0.1:9090/magzines/', // 期刊pdf服务地址前缀
